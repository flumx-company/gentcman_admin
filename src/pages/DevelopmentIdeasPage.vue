    ...
    export default {
        ...
        data:() => ({
            ...
            statuses: [
                ...
                { name: "общение с заказчиком", id: 'communication with the customer', color: 'rgba(255,165,0,0.8)' },
                { name: "оклонили", id: 'rejected', color: '#ff00008f' },
                { name: "в реализации", id: 'taken for implementation', color: 'rgba(0,128,0,0.41)' },
                { name: "реализовано", id: 'implemented', color: 'rgba(0,128,0,1)' },
            ],
            messageTemplates: []
        }),
